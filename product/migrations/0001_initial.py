# Generated by Django 4.0 on 2022-10-28 10:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=128)),
                ('kind', models.CharField(choices=[('Meal', 'Meal'), ('Food', 'Food'), ('Bakery', 'Bakery'), ('Beverage', 'Beverage'), ('DairyProduct', 'DairyProduct'), ('Snack', 'Snack'), ('Icecream', 'Icecream'), ('Necessaries', 'Necessaries'), ('Etc', 'Etc')], max_length=12)),
